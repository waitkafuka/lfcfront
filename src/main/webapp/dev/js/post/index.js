$(function() {
	...
	// "title" :
	// "我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题我是文章标题",
	// "tag" : "js框架,Angular",
	// "content" :
	// "内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章时光飞逝大概内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章内容章",
	// "author" : "张三",
	...
	// Mock.mock('http://localhost:8080/lfcfront/delPost?postId=198', {
	// "state" : 0
	// });
	...
	$(document)
			.on(
					...
					function(event) {
						...
						// var activeNum =
						// target.parents("#message_text").next().find(".active").html()
						// - 1;
						$
								.ajax({
									type : "get",
